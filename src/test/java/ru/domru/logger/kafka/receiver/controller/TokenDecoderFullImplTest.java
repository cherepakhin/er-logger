...
public class TokenDecoderFullImplTest {
    ...
    public void getInfoFromToken() {
        TokenDecoderFullImpl tokenDecoder = new TokenDecoderFullImpl();
        ...
        assertEquals(97719470L, device.get("id"));
    ...
    public void deserializeToken() {
        TokenDecoderFullImpl tokenDecoder = new TokenDecoderFullImpl();
        Token token = tokenDecoder.deserializeToken(TOKEN);
        assertNotNull(token);
    }
}